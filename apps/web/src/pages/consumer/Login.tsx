            ...
            <div className="glass-panel w-full max-w-md p-8 animate-fade-in">
                <div className="flex flex-col items-center justify-center gap-4 mb-10">
                    ...
                    <div className="text-center">
                        <h2 className="text-4xl font-black text-[#112244] italic tracking-tighter leading-none">Spendigo</h2>
                ...
                {mfaResolver && !verificationId ? (
                    ...
                    <button
                        ...
                        disabled={true}
                        onClick={() => {}}
                        className="w-full flex items-center justify-center gap-2 py-2.5 rounded-[var(--radius-sm)] bg-[#1877F2] text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm"
                    >
