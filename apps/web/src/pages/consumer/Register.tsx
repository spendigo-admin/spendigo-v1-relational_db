                            ...
                            <div className="animate-fade-in space-y-6">
                                ...
                                <div className="space-y-3 mb-6 bg-[var(--surface-0)] p-4 rounded-2xl border border-[var(--glass-border)]">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => {}}
                                        className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#1877F2] text-white font-bold transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed disabled:grayscale"
                                        disabled={true}
                                    >
