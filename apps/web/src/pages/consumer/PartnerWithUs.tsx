        ...
        <div className="bg-[var(--surface-0)] min-h-screen">
            ...
            <div className="relative pt-12 pb-16 md:pt-32 md:pb-40 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute top-1/4 -right-20 w-64 h-64 md:w-96 md:h-96 bg-emerald-50 rounded-full blur-3xl opacity-50 animate-pulse" />
                    <div className="absolute bottom-0 -left-20 w-64 h-64 md:w-96 md:h-96 bg-blue-50 rounded-full blur-3xl opacity-50 animate-pulse" style={{ animationDelay: '2s' }} />
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4 px-4 sm:px-0">
                        <Link to="/register/business" className="w-full sm:w-auto px-8 md:px-10 py-3.5 md:py-4 bg-[var(--brand-primary)] text-white font-black rounded-2xl shadow-xl shadow-blue-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all text-sm md:text-base text-center">
                            🚀 Get Started Free
                        </Link>
                        <Link to="/how-it-works" className="w-full sm:w-auto px-8 md:px-10 py-3.5 md:py-4 bg-white text-[var(--brand-primary)] font-black rounded-2xl border-2 border-[var(--brand-primary)] hover:bg-[var(--brand-primary-light)] transition-all text-sm md:text-base text-center">
                            Learn How it Works
                        </Link>
                    </div>
                </div>
            ...
            <section className="py-16 md:py-24 bg-white relative">
                <div className="max-w-5xl mx-auto px-4">
                    <div className="text-center mb-12 md:mb-20">
                        <h2 className="text-2xl md:text-4xl font-black text-[var(--text-main)] mb-4">How It Works</h2>
                        <div className="w-16 md:w-20 h-1.5 bg-[var(--brand-secondary)] mx-auto rounded-full" />
                    </div>
                            ...
                            <div key={item.step} className={`flex flex-col ${idx % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} items-center gap-8 md:gap-20`}>
                                <div className="flex-1 text-center md:text-left">
                                    ...
                                    <div className="flex items-center justify-center md:justify-start gap-3 mb-3 md:mb-4">
                                        <span className="text-[var(--brand-secondary)] font-black text-[10px] md:text-sm uppercase tracking-widest">Phase 0{item.step}</span>
                                        <div className="h-px w-6 md:w-8 bg-[var(--brand-secondary)]/30" />
                                    </div>
            ...
            <section className="py-20 md:py-32 bg-white text-center">
                <div className="max-w-4xl mx-auto px-4">
                    <div className="relative rounded-[2rem] md:rounded-[3rem] bg-gradient-to-br from-[var(--brand-primary)] to-[var(--brand-secondary)] p-8 md:p-20 overflow-hidden text-white shadow-2xl shadow-blue-500/20">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
                        <div className="relative z-10">
                            <h2 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Ready to Reach More Customers?</h2>
                            ...
                            <Link
                                ...
                                className="inline-flex items-center justify-center px-10 py-4 bg-white text-[var(--brand-primary)] font-black text-lg rounded-2xl shadow-xl hover:scale-105 active:scale-95 transition-all"
                            >
