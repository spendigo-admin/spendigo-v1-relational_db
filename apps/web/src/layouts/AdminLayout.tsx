                ...
                <div className="p-4 border-t border-[var(--glass-border)]">
                    <div className="flex items-center gap-3 p-2 rounded-lg bg-[var(--surface-1)]">
                        ...
                        <div className="flex-1 overflow-hidden">
                            <p className="text-sm font-bold text-[var(--text-main)] truncate">System Admin</p>
                            <p className="text-xs text-[var(--text-muted)] truncate">admin@spendigo.ca</p>
                        </div>
