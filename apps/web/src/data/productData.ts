...
// Helper: Get list of all stores for StoreList page
export function getStoreList() {
    return Object.values(STORE_DATA).map((store: any) => ({
        id: store.id,
        name: store.name,
...
// Build product price database from store data (for SmartCart)
