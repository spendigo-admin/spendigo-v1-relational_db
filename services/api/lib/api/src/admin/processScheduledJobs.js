...
exports.processScheduledJobs = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
const flippScraper_1 = require("../utils/flippScraper");
exports.processScheduledJobs = functions.pubsub.schedule('every 10 minutes').onRun(async (context) => {
...
//# sourceMappingURL=processScheduledJobs.js.map